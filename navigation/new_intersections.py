...
##TODO: remove nodes that arent intersections
##TODO: FIX dest_node METHOD (ERRORS caused with 97248035)
##TODO: If a road is one way, should it be stored as an intersection
